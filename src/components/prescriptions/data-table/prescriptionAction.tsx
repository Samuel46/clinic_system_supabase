...
import { deletePrescriptionAction } from "@actions/prescriptions.action";
import PrescriptionDelete from "../dialog/PrescriptionDelete";

export default function PrescriptionAction({ row }: { row: Row<PrescriptionColumns> }) {
  ...
  const handleDelete = async () => {
    startTransition(() => {
      deletePrescriptionAction(row.original.id).then((result) => {
        if (result.success) {
