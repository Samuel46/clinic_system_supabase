...
import { generateUniqueOptions } from "@utils/tenants";
...
export default function PageList<TData, TValue>({
  columns,
  data,
  filterableColumns,
    ...
    <FadeIn className=" space-y-6">
      ...
      <div className="flex items-center bg-muted/70 p-8 py-10 rounded-2xl">
        <DataTableToolbar
          ...
          placeholderText="Filter tenants..."
          table={table}
        />
      ...
      <Card className=" rounded-2xl">
        <CardHeader>
          ...
          <CardDescription>
            Overview of all your tenants. Possible to view and edit from here
          </CardDescription>
        </CardHeader>
