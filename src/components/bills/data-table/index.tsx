...
export default function BillList<TData, TValue>({
  columns,
  data,
  filterableColumns,
    ...
    <FadeIn className=" space-y-6">
      ...
      <Card className=" rounded-2xl">
        <CardHeader>
          ...
          <CardDescription>
            Overview of all your bills. Possible to view and edit from here
          </CardDescription>
        </CardHeader>

        <CardContent>
          <DataTable table={table} columns={columns} link="/admin/bills/" />
        </CardContent>
